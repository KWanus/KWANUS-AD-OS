...
const PALETTES = [
  { primary: "#06b6d4", secondary: "#8b5cf6", accent: "#10b981", mood: "Trust + Growth" },
  ...
  { primary: "#ec4899", secondary: "#8b5cf6", accent: "#f472b6", mood: "Creative + Bold" },
  ...
  { primary: "#8b5cf6", secondary: "#7c3aed", accent: "#a78bfa", mood: "Premium + Luxury" },
  ...
  { primary: "#22d3ee", secondary: "#06b6d4", accent: "#67e8f9", mood: "Calm + Clear" },
