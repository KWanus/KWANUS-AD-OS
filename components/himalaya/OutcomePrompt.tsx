      ...
      {!showNote ? (
        ...
        <div className="space-y-2">
          <textarea
            ...
            rows={2}
            className="w-full resize-none rounded-lg border border-white/[0.08] bg-white/[0.03] p-2.5 text-xs text-white/50 placeholder-white/15 focus:border-[#f5a623]/20 focus:outline-none"
          />
          {selected && (
            <button
              onClick={() => void handleSubmit(selected)}
              disabled={saving}
              className="rounded-lg border border-[#f5a623]/20 bg-[#f5a623]/10 px-4 py-2 text-xs font-bold text-[#f5a623] transition hover:bg-[#f5a623]/20 disabled:opacity-40"
            >
