    ...
    <div className="relative">
      ...
      <div className="relative -mt-4 flex flex-col items-center gap-2 py-4">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/20 text-[11px] font-bold text-cyan-400 hover:from-cyan-500/30 hover:to-purple-500/30 transition"
        >
