  ...
  return (
    <div className="relative" style={{ minWidth: 220 }}>
      ...
      <Handle
        ...
        className="!w-3 !h-3 !border-2 !border-orange-400 !bg-[#0c0a08] hover:!bg-orange-400 transition-colors"
        style={{ top: -6 }}
      />
      ...
      <Handle
        ...
        id="yes"
        className="!w-3 !h-3 !border-2 !border-green-400 !bg-[#0c0a08] hover:!bg-green-400 transition-colors"
        style={{ right: -6 }}
      />
      ...
      <Handle
        ...
        id="no"
        className="!w-3 !h-3 !border-2 !border-red-400 !bg-[#0c0a08] hover:!bg-red-400 transition-colors"
        style={{ left: -6 }}
      />
    </div>
  );
