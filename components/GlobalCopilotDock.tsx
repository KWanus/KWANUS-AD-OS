...
function verdictTone(status?: string) {
  ...
  if (status === "stale") return "border-[#f5a623]/20 bg-[#f5a623]/10 text-[#f5a623]";
            ...
            <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] px-3 py-3">
              ...
              {recommendationIsStale && state.unsyncedSystems.length === 0 && (
                <button
                  ...
                  className="mt-3 w-full rounded-xl border border-[#f5a623]/20 bg-[#f5a623]/10 px-3 py-2 text-xs font-bold text-[#f5a623] transition hover:bg-[#f5a623]/15 disabled:cursor-not-allowed disabled:opacity-60"
                >
