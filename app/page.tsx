  ...
  const continueCards = [
    {
      ...
      href: totalCampaigns > 0 ? "/campaigns" : "/scan",
      cta: totalCampaigns > 0 ? "Continue campaigns" : "Scan & create campaign",
      icon: Zap,
      accent: "cyan" as Accent,
    },
    {
    ...
    {
      label: "Email Flows",
      value: totalEmailFlows,
      sub: totalEmailFlows > 0 ? `${totalEmailFlows} automation${totalEmailFlows !== 1 ? "s" : ""} running` : "No email automations yet",
      href: "/emails",
      cta: totalEmailFlows > 0 ? "Open flows" : "Build first flow",
      icon: Mail,
      accent: "emerald" as Accent,
    },
    {
      label: "CRM Clients",
      value: totalClients,
      sub: totalClients > 0 ? `${atRiskClients.filter(c => c.healthStatus === "red").length} need attention` : "Track client relationships",
      href: "/clients",
      cta: totalClients > 0 ? "Open CRM" : "Add first client",
      icon: Users,
      accent: "blue" as Accent,
    },
  ];
