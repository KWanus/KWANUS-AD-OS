  ...
  return (
    <div className="min-h-screen bg-[#050a14] text-white">
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        <div className="mb-6 rounded-3xl border border-cyan-500/12 bg-gradient-to-br from-cyan-500/[0.06] via-transparent to-purple-500/[0.05] p-6 sm:p-8">
          <WorkflowHeader
            title="Book a Call"
            ...
            >
              <div className="rounded-2xl border border-cyan-500/15 bg-cyan-500/[0.06] p-4">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-cyan-200/70">Current Selection</p>
                </div>
              ...
              <div className="mt-4 space-y-3">
                <input
                  ...
                  className="w-full rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-3 text-sm text-white placeholder-white/20 focus:border-cyan-500/40 focus:outline-none"
                />
                <input
                ...
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 px-4 py-3 text-sm font-bold text-white transition hover:opacity-90 disabled:opacity-40"
                >
