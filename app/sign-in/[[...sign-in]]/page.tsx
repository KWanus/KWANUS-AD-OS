...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-[#0c0a08] flex flex-col items-center justify-center px-4">
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] opacity-[0.06] blur-[120px] pointer-events-none"
        style={{ background: "radial-gradient(ellipse, #f5a623 0%, #e07850 50%, transparent 70%)" }} />

      <div className="relative z-10 w-full max-w-sm">
        <Link href="/welcome" className="flex items-center justify-center gap-2 mb-8">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#f5a623] to-[#e07850] flex items-center justify-center shadow-[0_0_20px_rgba(245,166,35,0.3)]">
        ...
        <p className="mt-4 text-center text-xs text-white/20">
          ...
          <Link href="/sign-up" className="text-[#f5a623] hover:text-[#f5a623] font-bold transition">
            Sign up free →
          </Link>
        </p>
      </div>
