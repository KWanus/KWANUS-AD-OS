...
const PLAN_CONFIG: Record<string, { label: string; color: string; bg: string; border: string; icon: React.ElementType }> = {
  ...
  elite: { label: "Elite", color: "text-[#e07850]", bg: "bg-[#e07850]/10",  border: "border-[#e07850]/20",  icon: Shield },
};
...
export default function SettingsPage() {
  ...
  "data": { "email": "...", "tags": [...] }
            ...
            <button
              ...
              disabled={saving}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#e07850]/20 hover:bg-[#e07850]/30 border border-[#e07850]/30 text-[#e07850] text-xs font-bold transition disabled:opacity-40"
            >
              ...
              <div key={name} className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/[0.05]">
                ...
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md border ${
                  status === "active"
                    ...
                    : status === "upgrade"
                    ? "text-[#e07850] bg-[#e07850]/10 border-[#e07850]/20"
