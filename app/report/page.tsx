            ...
            {selected === null && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  ...
                  className="rounded-2xl border border-white/10 bg-white/5 p-6 text-left hover:border-[#f5a623]/40 hover:bg-white/10 transition"
                >
                  ...
                  <span className="text-xs text-[#f5a623] border border-[#f5a623]/30 rounded-full px-3 py-1">Upload Reports →</span>
                </button>

                <button
                  onClick={() => setSelected("upload")}
                  className="rounded-2xl border border-[#f5a623]/30 bg-[#f5a623]/5 p-6 text-left hover:border-[#f5a623]/60 hover:bg-[#f5a623]/10 transition"
                >
                  ...
                  <span className="text-xs text-[#f5a623] border border-[#f5a623]/30 rounded-full px-3 py-1">Start Here</span>
                </button>
              </div>
            )}
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-white outline-none focus:border-[#f5a623]/60 transition"
                    >
