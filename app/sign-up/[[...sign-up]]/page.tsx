...
export default function SignUpPage() {
  return (
    <div className="min-h-screen bg-[#020509] flex flex-col items-center justify-center px-4">
      ...
      {/* Value prop above form */}
      <p className="text-xs text-white/30 mb-8 text-center">
        Sites · Emails · CRM · AI Skills · Campaigns — all in one place.
      </p>
      ...
      <p className="mt-6 text-xs text-white/20">
        ...
        <Link href="/sign-in" className="text-cyan-400 hover:text-cyan-300 font-bold transition">
          Sign in →
        </Link>
      </p>
    </div>
