        ...
        {!page ? (
          ...
          <div className="space-y-4">
            <div className="flex gap-2">
              <button onClick={copyPage} className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#f5a623] text-[#0a0f1e] text-xs font-bold hover:bg-[#e07850] transition">
            ...
            <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-8 text-center">
              ...
              <div className="rounded-xl border border-[#f5a623]/20 bg-[#f5a623]/5 p-4">
                <p className="text-xs text-[#f5a623]/70">{page.upsell}</p>
              </div>
            </div>
          </div>
        )}
