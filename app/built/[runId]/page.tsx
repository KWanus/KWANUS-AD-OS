  ...
  return (
    <main className="min-h-screen bg-t-bg text-t-text">
      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 pb-20">
        ...
        {/* Your playbook */}
        <div className="rounded-xl border border-[#f5a623]/15 bg-[#f5a623]/[0.03] p-4 mb-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-black">Your Playbook is Ready</p>
              <p className="text-[10px] text-t-text-faint mt-0.5">Step-by-step plan customized for your business type. Daily routine, weekly milestones, revenue math.</p>
            </div>
            <Link href="/playbook" className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#f5a623]/10 border border-[#f5a623]/20 text-xs font-bold text-[#f5a623] hover:bg-[#f5a623]/20 transition">
