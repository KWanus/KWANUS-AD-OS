        ...
        {running ? (
          ...
          <>
            ...
            <div className="space-y-6 rounded-3xl border border-white/[0.06] bg-gradient-to-br from-white/[0.03] via-white/[0.015] to-transparent p-4 sm:p-5">
              {/* URL */}
              <div>
                <label className="text-[10px] font-bold text-[#f5a623]/50 uppercase tracking-widest mb-2 block">Your website URL</label>
                <input
                  value={url}
                  onChange={(e) => setUrl(e.target.value)}
                  placeholder="https://yourbusiness.com"
                  autoFocus
                  className="w-full bg-white/[0.04] border border-[#f5a623]/15 rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#f5a623]/30"
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#f5a623]/30 resize-none"
                />
              </div>
