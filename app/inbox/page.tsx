...
const TYPE_CONFIG: Record<InboxItem["type"], { label: string; icon: ElementType; tone: string }> = {
  form: { label: "Form", icon: Mail, tone: "border-cyan-500/20 bg-cyan-500/10 text-cyan-300" },
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div className="grid grid-cols-3 gap-2 sm:flex">
              ...
              <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/10 px-4 py-3">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-cyan-200/60">Unread</p>
                <p className="mt-1 text-lg font-black text-cyan-300">{unreadCount}</p>
              </div>
              <button
                  ...
                  return (
                    <button
                      ...
                      className={`w-full rounded-2xl border p-4 text-left transition ${
                        active
                          ? "border-cyan-400/30 bg-cyan-500/[0.08] shadow-[0_0_0_1px_rgba(34,211,238,0.08)]"
                          : item.read
                            ? "border-white/[0.07] bg-black/20 hover:border-white/[0.12]"
                            : "border-cyan-500/20 bg-gradient-to-br from-cyan-500/[0.08] via-white/[0.02] to-transparent hover:border-cyan-400/30"
                      }`}
                    >
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div className="min-w-0 flex-1">
                          <div className="mb-2 flex flex-wrap items-center gap-2">
                            ...
                            {!item.read && (
                              <span className="inline-flex items-center rounded-full border border-cyan-500/20 bg-cyan-500/10 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-cyan-300">
                                New
                              </span>
                            )}
                          </div>
                        ...
                        <ChevronRight className={`mt-0.5 h-4 w-4 shrink-0 transition ${active ? "text-cyan-300" : "text-white/20"}`} />
                      </div>
                ...
                <>
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    ...
                    {detailHref && (
                      <Link
                        href={detailHref}
                        className="inline-flex items-center gap-2 rounded-xl border border-cyan-500/20 bg-cyan-500/10 px-3 py-2 text-xs font-semibold text-cyan-300 transition hover:bg-cyan-500/15"
                      >
                        Open Workspace
